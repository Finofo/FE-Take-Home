...
1. **Data Fetching**
   ...
   - Currently the Fruityvice API is down so we prepared for you a simple [GET endpoint](https://wcz3qr33kmjvzotdqt65efniv40kokon.lambda-url.us-east-2.on.aws/) with a copy of the Fruityvice API response data.
